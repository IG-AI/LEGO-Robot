...
class BaseMotor(object):
    ...
    def turn(self, power, tacho_units, brake=True, timeout=1, emulate=True):
        """Use this to turn_cardinal a motor. The motor will not stop until it turns the
        ...
        power is a value between -127 and 128 (an absolute value greater than
                 64 is recommended)
        tacho_units is the number of degrees to turn_cardinal the motor. values smaller
        ...
        timeout is the number of seconds after which a BlockedException is
                 raised if the motor doesn't turn_cardinal
...
class Motor(BaseMotor):
    def __init__(self, brick, port):
        ...
        try:
            ...
            print("For now, turn_cardinal() accuracy will not be optimal.")
    ...
    def weak_turn(self, power, tacho_units):
        """Tries to turn_cardinal a motor for the specified distance. This function
